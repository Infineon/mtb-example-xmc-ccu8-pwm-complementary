...
* File Name:   main.c
*
* Description: This is the source code for the XMC MCU: CCU8 Complementary PWM Example
*              for ModusToolbox.
*              One CCU8 slice is configured to generate complementary PWM in the project.
*              Dead time insertion is also done between the compelementary PWM waves.
...
XMC_CCU8_SLICE_COMPARE_CONFIG_t ccu80_slice_pwm_config =
{
        ...
        .slice_status          = (uint32_t)XMC_CCU8_SLICE_STATUS_CHANNEL_1,             /* Ch1 drives slice status output */
...
const XMC_GPIO_CONFIG_t  ccu8_pwm_gpio1_config    =
{
   ...
   .output_level        = XMC_GPIO_OUTPUT_LEVEL_LOW,                                    /* Ouput level of pin */
...
/*
* Dead Time insertion configuartion
*/
const XMC_CCU8_SLICE_DEAD_TIME_CONFIG_t  dt_config =
    {
      ...
      .channel1_st_path                  = 1U,                                          /* Dead time insered for direct output of Ch1 */
      .channel1_inv_st_path              = 1U,                                          /* Dead time insered for invert output of Ch1 */
      .channel2_st_path                  = 0U,                                          /* Dead time insered for direct output of Ch2 */
      .channel2_inv_st_path              = 0U,                                          /* Dead time insered for invert output of Ch2 */
      .div                               = (uint32_t)XMC_CCU8_SLICE_DTC_DIV_1,          /* Dead time prescaler divider value*/
...
int main(void)
{
    ...
    XMC_CCU8_SLICE_SetTimerCompareMatch(PWM_SLICE_PTR, XMC_CCU8_SLICE_COMPARE_CHANNEL_1, PWM_COMPARE);
